                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li><a href="{{ route('account') }}"><i class="ti-user"></i><span>Quản lý tài khoản</span></a></li>
                            <li class="active"><a href="{{ route('post') }}"><i class="ti-image"></i> <span>Quản lý bài đăng</span></a></li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <h4 class="page-title pull-left">Post Management</h4>
                            {{-- <ul class="breadcrumbs pull-left">
                                <li><a href="index.html">Quản lý</a></li>
                                <li><span>Bài đăng</span></li>
                            </ul> --}}
                        </div>
                    </div>
                    <style>
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            <img class="avatar user-thumb" src="{{ asset('img/avt-user/' . Auth::user()->avatar) }}" alt="avatar">
